...
global_bex.load_content = function(){
	...
	$global_content = {
		header_2_1: 'Vollmachten',
	    content_2_1: '<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/strafprozessvollmacht-rechtsanwalt-bex.pdf" rel="external" target="_blank">Strafprozessvollmacht öffnen</a>\
		<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/prozessvollmacht-rechtsanwalt-bex.pdf" rel="external" target="_blank">Prozessvollmacht öffnen</a>\
		...
		header_2_2: 'Dokumente',
		content_2_2: '<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/Verguetungsvereinbarung-Prozess-Rechtsanwalt-Bex.pdf" rel="external" target="_blank">Vergütungsvereinbarung Prozess</a>\
			<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/Verguetungsvereinbarung-Prozess-Rechtsanwalt-Bex.pdf" rel="external" target="_blank">Vergütungsvereinbarung ausserger.</a>\
			<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/Verguetungsvereinbarung-Prozess-Rechtsanwalt-Bex.pdf" rel="external" target="_blank">Gebührenvereinbarung</a>\
			<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/Verguetungsvereinbarung-Prozess-Rechtsanwalt-Bex.pdf" rel="external" target="_blank">Entbindungserklärung</a>\
			<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/Verguetungsvereinbarung-Prozess-Rechtsanwalt-Bex.pdf" rel="external" target="_blank">Mandantenauskunft</option>\
			<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/Verguetungsvereinbarung-Prozess-Rechtsanwalt-Bex.pdf" rel="external" target="_blank">Zeugenentschädigungsverzichtserklärung</a>\
			<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/Verguetungsvereinbarung-Prozess-Rechtsanwalt-Bex.pdf" rel="external" target="_blank">Abtretungserklärung</a>\
			<a data-role="button"  data-theme="a" data-icon="arrow-r" data-iconpos="right" class="button" href="http://www.rechtsanwalt-bex.de/downloads/Verguetungsvereinbarung-Prozess-Rechtsanwalt-Bex.pdf" rel="external" target="_blank">Untervollmacht</option></a>\
...
/*<select  data-theme="a" name="select_document" id="select_document" ><option>Bitte wählen Sie ein Dokument:</option>\
